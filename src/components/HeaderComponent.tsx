...
import { opacity, background } from "../components/Animation";
import Nav from "./layout/project-layout/Nav";
...
export default function Index() {
  ...
  return (
    <div className={styles.header}>
      ...
      ></motion.div>
      <AnimatePresence exitBeforeEnter>{isActive && <Nav />}</AnimatePresence>
    </div>
  );
}
