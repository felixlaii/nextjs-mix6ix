...
const PageHeading: React.FC<PageHeadingProps> = ({ title }) => {
  return (
    <>
      <div className="mt-[12rem] flex justify-center h-full w-screen bg-[url('https://res.cloudinary.com/dyjj9jfc2/image/upload/v1687549205/frantisek-g-XXuVXLy5gHU-unsplash_ywkclz.jpg')]">
